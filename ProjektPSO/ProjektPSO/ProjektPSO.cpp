...
int main()
{
    ...
    //PRINT TO FILE
    std::ofstream out;
    out.open("C:\\Dane\\dane.txt", std::ios::app);
    out << "------------------------------------" << std::endl;
    out << "Funkcja NR: " << function << std::endl;
    out << "Liczba czastek: " << particles << std::endl;
    out << "Liczba epok: " << iteration << std::endl;
    out << "MinRand: " << minRand << std::endl;
    out << "MaxRand: " << maxRand << std::endl;
    out << "Maksymalny blad funkcji: " << FunctionValueError << std::endl;
    out << "Wspolczynnik bezwladnosci: " << W << std::endl;
    out << "Wspolczynnik dazenia do najlepszego lokalnego rozwiazania: " << C1 << std::endl;
    out << "Wspolczynnik dazenia do najlepszego globalnego rozwiazania: " << C2 << std::endl;
    out << "------------------------------------" << std::endl;
    out.close();
